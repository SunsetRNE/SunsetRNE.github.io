...
> 我的自建项目精选。想实时看全部仓库动态，直接看首页的"GitHub 动态"区——那里自动拉取，永远是最新的。
...
### [SunsetRNE.github.io](https://github.com/SunsetRNE/SunsetRNE.github.io)
<div class="desc">就是本站：VitePress 驱动的个人工作站，含 48 个 fork 的上游自动同步监控系统。</div>
<div class="tags"><span class="tag">VitePress</span><span class="tag">Vue</span><span class="tag">Markdown</span></div>
...
| 指标 | 数值 |
| --- | --- |
| 公开仓库 | 54（自建精选 6 · fork/复刻 48） |
| 总 Stars | 29 |
| 主要语言 | Shell · Kotlin · Rust · Python · Vue |

> 💡 首页的 GitHubRepos 组件会实时拉取 GitHub API，push 新仓库后网站自动更新，这个表格只是静态参考。